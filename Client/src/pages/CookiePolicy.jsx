...
const CookiePolicy = () => {
  ...
  const HeroSkeleton = () => (
    <div className="text-center mb-8 animate-pulse">
      ...
      <div className="w-3/4 h-8 bg-gray-300 rounded mx-auto mb-4"></div>
  ...
  const TableSkeleton = () => (
    <div className="overflow-x-auto mb-8 animate-pulse">
  ...
  const ListSkeleton = () => (
    <div className="space-y-2 ml-4 mb-8 animate-pulse">
      {[1, 2, 3, 4].map((item) => (
  ...
  const ContactBoxSkeleton = () => (
    <div className="bg-gray-50 p-4 rounded-lg mt-3 mb-8 animate-pulse">
  ...
  const NoteBoxSkeleton = () => (
    <div className="mt-12 p-6 bg-gray-100 rounded-lg border border-gray-200 mb-8 animate-pulse">
  ...
  const BackButtonSkeleton = () => (
    <div className="mt-8 text-center animate-pulse">
      <div className="inline-flex items-center w-32 h-8 bg-gray-300 rounded mx-auto"></div>
    </div>
  );
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 relative overflow-hidden">
        {/* Animated Background (same as original) */}
        <div className="absolute inset-0 overflow-hidden">
          <div
            className="absolute top-10 left-10 w-24 h-24 bg-blue-300 rounded-full opacity-30 animate-bounce"
            style={{ animationDuration: "3s" }}
          ></div>
          <div
            className="absolute top-20 right-16 w-20 h-20 bg-purple-300 rounded-full opacity-40 animate-ping"
            style={{ animationDuration: "4s" }}
          ></div>
          <div
            className="absolute bottom-32 left-1/4 w-28 h-28 bg-pink-300 rounded-full opacity-25 animate-pulse"
            style={{ animationDuration: "2s" }}
          ></div>
          <div
            className="absolute bottom-20 right-1/3 w-16 h-16 bg-cyan-300 rounded-full opacity-35 animate-bounce"
            style={{ animationDuration: "5s" }}
          ></div>
        </div>

        {/* Navbar Skeleton */}
        <div className="fixed w-full top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-1/3 left-1/4 w-12 h-12 bg-yellow-300 rounded-lg opacity-30 animate-spin"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-14 h-14 bg-green-300 rounded-lg opacity-25 animate-pulse"
          style={{ animationDuration: "3s" }}
        ></div>
      </div>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    help us provide you with a better experience and understand
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        We use these cookies to understand how visitors interact
                        with our website. They help us improve our services by
                ...
                <section>
                  ...
                  <p className="text-gray-700">
                    ...
                    through the service, and so on. These third parties may set
                    cookies to help us track user behavior.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mt-3">
                    <p className="text-gray-700">
                      <strong>Email:</strong> privacy@excellenceallegiance.com
                      <br />
              ...
              <div className="mt-12 p-6 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <p className="text-yellow-700">
                  By continuing to use our website without changing your
                  settings, you consent to our use of cookies as described in
                  this policy.
                </p>
              </div>
              ...
              <div className="mt-8 text-center">
                <Link
                  to="/"
                  className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium text-lg transition-colors duration-300 hover:scale-105"
                >
                  <svg
