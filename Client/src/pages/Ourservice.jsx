...
const OurService = () => {
  ...
  const openProcessModal = useCallback((process) => {
  ...
  // Filter payment methods for a specific service
  const getServicePaymentMethods = useCallback(
    (service) => {
  ...
  const handleFilterClick = useCallback((key) => {
    // When switching filters clear search and collapse expanded service cards
    setActiveFilter(key);
    setSearchQuery("");
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        ...
        >
          <div className="sticky top-0 z-10 flex items-center justify-between p-6 border-b bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-t-3xl">
            <div className="flex items-center space-x-4">
              <div className="text-3xl">{process.icon || "ℹ️"}</div>
              <div>
  ...
  return (
    ...
    >
      ...
      {/* Hero Section - Custom Background with Tech Theme */}
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black">
            ...
            <div className="absolute top-1/3 right-1/4 w-40 h-40 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full blur-3xl animate-pulse delay-700"></div>
            <div className="absolute bottom-1/4 left-1/3 w-48 h-48 bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 rounded-full blur-3xl animate-pulse delay-1400"></div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white space-y-8">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-cyan-500/30">
              ...
              <p className="text-xl md:text-2xl text-gray-200 leading-relaxed max-w-2xl">
                Cutting-edge technology services that propel your business into
                the future. From concept to deployment, we deliver excellence at
                every step.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-6">
                {[
                  { value: "200+", label: "Projects", color: "text-cyan-300" },
                  {
                    value: "98%",
                    label: "Success Rate",
                    color: "text-emerald-300",
                  },
                  { value: "50+", label: "Clients", color: "text-blue-300" },
                  { value: "24/7", label: "Support", color: "text-purple-300" },
                ].map((stat, idx) => (
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                <a
                  href="#services"
                  className="border-2 border-white/30 hover:border-cyan-400 hover:bg-gradient-to-r hover:from-cyan-500/10 hover:to-blue-500/10 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center justify-center group"
                >
                  <svg
            ...
            {/* Right Side - Main Image with Floating Tech Cards */}
            <div className="relative">
              ...
              <div className="relative w-full max-w-lg mx-auto">
                ...
                <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-gradient-to-tr from-purple-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
                ...
                <div className="relative rounded-3xl overflow-hidden border-8 border-white/10 backdrop-blur-sm bg-gradient-to-br from-gray-800/30 to-gray-900/50 p-2 shadow-2xl">
                  ...
                  <div className="relative rounded-2xl overflow-hidden">
                    ...
                    {/* Image কে replace করার জন্য উপরের div-টা সরিয়ে এই লাইন দিয়ে image যোগ করুন: */}
                    {/* <img 
                  ...
                  <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-6 py-2 rounded-full font-bold shadow-lg flex items-center gap-2">
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                ...
                <div className="absolute -bottom-6 -right-6 animate-float-medium">
                  <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-2xl p-4 border border-purple-500/30 shadow-xl">
                    <div className="flex items-center gap-3">
                      <div className="text-2xl">🤖</div>
                      <div>
                        <div className="text-sm font-bold text-white">
          ...
          <section id="services" className="py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
              {filteredServices.map((service) => (
                ...
                >
                  <div className="p-6">
                    {/* Service Header with Icon and Rating */}
