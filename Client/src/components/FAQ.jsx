      ...
      questions: [
        {
          ...
          answer:
            "We offer web development, mobile app development, e-commerce solutions, cloud services, AI/ML solutions, and IT consulting services.",
          tags: ["services", "overview"],
        },
        {
          question: "Where is your company located?",
          answer:
            "We are based in Kolkata, West Bengal, India, but we serve clients worldwide.",
          tags: ["location", "global"],
        },
        {
          question: "Do you work with international clients?",
          answer:
            "Yes, we have experience working with clients from USA, UK, Canada, Australia, and Middle Eastern countries.",
      ...
      questions: [
        {
          ...
          answer:
            "Our process includes: 1) Requirement Analysis, 2) Planning & Design, 3) Development, 4) Testing, 5) Deployment, and 6) Support.",
          tags: ["process", "methodology"],
        },
        {
          question: "Do you provide project timelines?",
          answer:
            "Yes, we provide detailed project timelines and regular progress updates throughout the development process.",
          tags: ["timeline", "progress"],
        },
        {
          question: "Can you work with our existing team?",
          answer:
            "Absolutely! We can collaborate with your in-house team and work as an extension of your development department.",
      ...
      questions: [
        {
          ...
          answer:
            "We require 50% advance and 50% on delivery. For larger projects, we offer flexible payment plans with milestones.",
          tags: ["payment", "terms"],
        },
        {
          question: "Do you offer maintenance packages?",
          answer:
            "Yes, we offer monthly and yearly maintenance packages that include updates, security patches, and technical support.",
          tags: ["maintenance", "support"],
        },
        {
          question: "Are there any hidden costs?",
          answer:
            "No, we provide transparent pricing with no hidden costs. All charges are discussed and approved before starting.",
      ...
      questions: [
        {
          ...
          answer:
            "We provide 6 months of free support, including bug fixes and minor updates. After that, we offer affordable maintenance packages.",
          tags: ["support", "post-launch"],
        },
        {
          question: "Do you provide training for our team?",
          answer:
            "Yes, we provide comprehensive training and documentation to help your team manage the system effectively.",
            ...
            <div className="space-y-4">
              {faqData
                ...
                ?.questions.map((faq, index) => {
                  ...
                  const categoryGradient = faqData.find(
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${categoryGradient} opacity-0 group-hover:opacity-5 transition-opacity`}
                      ></div>
                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <span
                              className={`text-sm px-3 py-1 rounded-full bg-gradient-to-r ${categoryGradient} text-white font-medium`}
                            >
                              {faq.tags[0]}
                            </span>
                          </div>
            ...
            <div className="relative inline-block group">
              ...
              <div className="relative bg-gradient-to-br from-white to-gray-50 border border-gray-200/50 rounded-3xl p-8 md:p-12 backdrop-blur-sm">
                ...
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                  ...
                  instantly. Get personalized responses based on your specific
                  needs.
                </p>
