        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="h-19 w-16 md:h-16 md:w-1 lg:h-20 lg:w-20 flex-shrink-0">
                <img
                  src="/eapl.png"
                  alt="Excellence Allegiance Logo"
              ...
              <div>
                <h3 className="text-white font-bold text-sm sm:text-base whitespace-nowrap">
                  Excellence Allegiance
                </h3>
                <div><p>Private Limited</p></div>
          ...
          <div>
            ...
            <Link
              to="/contact"
              className="block text-gray-300 hover:text-cyan-400 transition-colors duration-300 mb-4"
            >
              Contact Us
            </Link>
