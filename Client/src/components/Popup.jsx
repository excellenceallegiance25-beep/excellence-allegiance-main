...
const Popup = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div
        className={`${styles.bgColor} border ${styles.borderColor} rounded-lg shadow-xl p-6 max-w-md w-full mx-4 animate-in`}
      >
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-1">
            ...
            <p className={`text-sm ${title ? "mt-2" : ""} text-gray-700`}>
              {message}
            </p>
          </div>
          <button
